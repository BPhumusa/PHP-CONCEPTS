...
<ul id="menu">
			...
			<li><a href ="http://sechaba.bac.ac.bw:8080/cis15-040/PRODUCT DEVELOPMENT/Register.php" style="float:right"><button type="button">Register </button></a></li>
            <li><a href ="http://sechaba.bac.ac.bw:8080/cis15-040/PRODUCT DEVELOPMENT/Login.php" style="float:right"><button type="button">  Login </button></a></li>			
